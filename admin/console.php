...
<html lang="en">
  <head>
    ...
    <title>Attendance Monitoring System | Console</title>
	...
	<style type="text/css">
		...
		#page-content .panel-body h4 {
			margin-top: 30px;
		}
		
		#rfid-scanner th, #rfid-scanner td, #gsm-modem th, #gsm-modem td {
			text-align: center;
  ...
  <body ng-app="appConsole" ng-controller="appConsoleCtrl">
			...
			<div id="page-content" class="col-lg-12">
				...
				<div class="panel panel-default">
				  <div class="panel-body">
						...
						<div class="row">
							<div class="col-lg-6">
								<table id="rfid-scanner" class="table table-bordered">
									<thead>
										<tr><th>Status</th><th>Action</th></tr>									
									</thead>
									<tbody>
										<tr><td>Ready</td><td><button type="button" class="btn btn-primary btn-sm">Refresh</button></td></tr>
									</tbody>
								</table>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-7">
								<table id="gsm-modem" class="table table-bordered">
									<thead>
										<tr><th>Status</th><th>SMS</th><th>Actions</th></tr>									
									</thead>
									<tbody>
										<tr>
											<td>Ready</td>
											...
											<td>
												<div class="btn-group" role="group">
													...
													<button type="button" class="btn btn-info btn-sm">Test</button>
	...
	<script src="controllers/appConsole.js"></script>
